<template>
    ...
    <g>
        <defs>
            ...
            <filter x="-34.5%" y="-57.7%" width="169.0%" height="215.4%" filterUnits="objectBoundingBox" id="portal_filter-4">
            ...
            <filter x="-7.7%" y="-13.4%" width="115.3%" height="126.7%" filterUnits="objectBoundingBox" id="portal_filter-7">
            ...
            <path d="M0,0 L150,0 L150,78 L149.989952,78.7110836 C149.334266,101.897151 116.670287,120.622172 76.2278833,120.994354 L75,121 L73.7597379,120.994239 C33.3189218,120.618312 0.659002463,101.890964 0.00984815708,78.7039864 L0,78 L0,0 Z" id="portal_path-8"></path>
        </defs>
                    ...
                    <g id="graphical_portal" :style="portalStyle" :transform="portalTransform">
                        <g transform="translate(0.000000, 26.000000)">
                            ...
                            <g id="Mask" filter="url(#portal_filter-2)">
                                <use fill="black" fill-opacity="1" filter="url(#portal_filter-4)" xlink:href="#portal_path-1"></use>
                            ...
                            <g id="Rectangle" mask="url(#mask-3)">
                                <g transform="translate(12.000000, 9.000000)">
                                    ...
                                    <g id="Mask" stroke="none" fill="none">
                                        ...
                                        <use fill="black" fill-opacity="1" filter="url(#portal_filter-7)" xlink:href="#portal_path-5"></use>
                                    </g>
                                </g>
                            </g>
                        </g>
                    </g>
                    <g id="Mask-Contents" transform="translate(12.000000, 0.000000)">
                        <mask id="mask-9" fill="white">
                            <use xlink:href="#portal_path-8"></use>
                        </mask>
                        <use id="Mask" fill="#D8D8D8" opacity="0" xlink:href="#portal_path-8"></use>
                        <g id="portal_content" mask="url(#mask-9)">
                            <slot></slot>
                        </g>
                    </g>
                </g>
