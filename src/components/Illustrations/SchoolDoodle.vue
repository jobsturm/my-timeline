        ...
        >
            <g id="copybook_lines" :transform="coords.copybook.transform" stroke-width="4">
                <g transform="translate(0, -245)">
                    ...
                    <AnimationPath nodeName="line" :drawPercentage="as.redCopybookLine" :x1="redLineX" y1="-5.31275443e-14" :x2="redLineX" y2="450" id="copybook_red_line" stroke="#FFE9EE"/>
                </g>
            </g>
            <g id="drawings" :transform="coords.copybook.transform">
                <g id="house" transform="translate(100, -165)" stroke="#056CF2" stroke-linejoin="round">
                ...
                <g v-if="windowWidth > 600" id="tree" transform="translate(240, -196)" stroke="#056CF2">
                ...
                <g v-if="windowWidth > 1000" id="tree" transform="translate(360, -196)" stroke="#056CF2">
...
<style lang="sass" scoped>
    ...
    .school_doodle__text
        ...
        padding-left: 94px
        line-height: 40px
        font-size: max(min(1.5em, 18px), 14px)
        font-weight: 400
